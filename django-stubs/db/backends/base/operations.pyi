...
class BaseDatabaseOperations:
    ...
    def datetime_trunc_sql(self, lookup_type: str, sql: str, params: Any, tzname: str | None) -> tuple[str, Any]: ...
    def time_trunc_sql(self, lookup_type: str, sql: str, params: Any, tzname: str | None = None) -> tuple[str, Any]: ...
    def time_extract_sql(self, lookup_type: str, sql: str, params: Any) -> tuple[str, Any]: ...
    ...
    def prepare_join_on_clause(
        self, lhs_table: str, lhs_field: Field | FieldCacheMixin, rhs_table: str, rhs_field: Field | FieldCacheMixin
    ) -> tuple[Col, Col]: ...
