...
class BaseDatabaseIntrospection:
    ...
    def get_table_list(self, cursor: CursorWrapper) -> Any: ...
    def get_table_description(self, cursor: CursorWrapper, table_name: str) -> Any: ...
    ...
    def get_sequences(self, cursor: CursorWrapper, table_name: str, table_fields: Any = ()) -> Any: ...
    ...
    def get_constraints(self, cursor: CursorWrapper, table_name: str) -> Any: ...
